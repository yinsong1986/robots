...
class LiberoAdapter(BenchmarkProtocol):
    ...
    def _scene_cache_key(self, bddl_bytes: bytes) -> str:
        ...
        post-process logic in :func:`_apply_libero_visual_fixes`
        changes (e.g. round 8 added collision-geom hiding + headlight
        boost). Bumping invalidates stale on-disk caches generated by
        prior versions so users picking up the upgrade automatically
